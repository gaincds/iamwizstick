...
class Window(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        grid = QtGui.QVBoxLayout()#.QVeticalLayout()
        ...
        grid.addWidget(self.createFirstExclusiveGroup(), 0)
        grid.addWidget(self.createSecondExclusiveGroup(), 1)
        grid.addWidget(self.createNonExclusiveGroup(), 2)
        grid.addWidget(self.createPushButtonGroup(), 3)
